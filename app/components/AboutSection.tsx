  ...
  return (
    <AnimatedSection id="about" className="py-16">
      ...
      <motion.div
        ...
        className="glow-card neon-border relative mt-8 overflow-hidden bg-gradient-to-br from-white/5 via-white/0 to-indigo-500/10 p-8 text-slate-200 shadow-[0_0_30px_rgba(99,102,241,0.18)]"
      >
        ...
        <div className="relative space-y-4 text-sm leading-7 md:text-base">
          <p>
